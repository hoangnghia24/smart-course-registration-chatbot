...
--
-- MIGRATION VERSION FOR smart_course_registration_chatbot
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('smart_course_registration_chatbot', '20260911080611421', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260911080611421', "timestamp" = now();
